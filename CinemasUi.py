...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cinemas_tree.setGeometry(QtCore.QRect(490, 40, 291, 261))
        self.cinemas_tree.setObjectName("cinemas_tree")
        self.add_form_widget = QtWidgets.QWidget(parent=self.centralwidget)
        self.add_form_widget.setGeometry(QtCore.QRect(10, 40, 461, 291))
        ...
        self.comboBox.setGeometry(QtCore.QRect(10, 10, 151, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Добавление объектов"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Удаление объектов"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Настройка сеанса"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Составление расписания"))
